...
export const NavBar = () => {
    ...
    <nav className="navbar navbar-expand-lg bg-success">
        <div className="container-fluid ">
            ...
            <Link className="navbar-brand " to="/"><GiClothes size={45} color={"#fff"}/><span className='ps-2 text-white'>Todo Ropa</span></Link>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav ">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link text-white" to="/category/camperas">Camperas</Link>
                    </li>
                    <li className="nav-item">
